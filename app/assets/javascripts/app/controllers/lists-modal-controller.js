angular.module('app').controller('ListsModalController', ['$scope', '$modalInstance', 'QueuedLists', 'UserFactory', 'ReadyList', '$state', '$http', function ($scope, $modalInstance, QueuedLists, UserFactory, ReadyList, $state, $http) {
